    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto justify-content-center mb-md-0">
          ...
          <li><a href="https://github.com/carlosjose1267/carlosjoseapplaravel" target="_blank" class="nav-link px-2 link-body-emphasis"><i class="fa-solid fa-file-code"></i>&nbsp; Documentación-GitHub</a></li>
